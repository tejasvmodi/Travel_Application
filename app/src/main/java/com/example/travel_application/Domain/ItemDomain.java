...
public class ItemDomain implements Serializable {
    ...
    public String getTorGuideName() {
        return torGuideName;
    }

    public void setTorGuideName(String torGuideName) {
        this.torGuideName = torGuideName;
    }
